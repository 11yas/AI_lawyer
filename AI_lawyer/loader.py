...
# Prefer langchain's official package path; fall back to legacy package if needed.
import importlib
try:
    mod = importlib.import_module("langchain.text_splitters")
    ...
    try:
        ...
        raise ImportError("RecursiveCharacterTextSplitter not found; install 'langchain' or 'langchain_text_splitters'")
